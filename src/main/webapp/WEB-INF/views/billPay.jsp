				...
				<form method="post" action="#">					
					...
					<table style="width:100%">
	  					...
	  					<tr>
						    ...
						    <td> PRINT MERCHANT NAME HERE</td> 
						    <td> PRINT AMOUNT HERE</td> 
						    <td> <input type="submit" style="margin-right: 5%" name="billPay" width="50" id="billPayButton" value="Pay" /></td>
						</tr>
					</table>
				</form>
				<br/> <br/> <br/>
