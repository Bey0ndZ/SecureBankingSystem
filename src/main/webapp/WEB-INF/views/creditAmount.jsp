		...
		<div class="content_wrapper">
			<div class="contentright" style="width: 100%">
				<form method="post" action="#">
					<i><b>Credit Money at Bank of G5!</b></i> <br/>					
					<p> Current Account Balance: PRINT BALANCE HERE --</p>
					
					<h6>Amount:</h6><input type="number" name="amount" id="transfer_amount" style="color:#999;" /> <br/><br/>
					<input type="submit" name="credit" id="creditButton" value="Credit" />
				</form>
			</div>
